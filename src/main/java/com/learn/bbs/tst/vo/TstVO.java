...
public class TstVO {
	...
	public ArtcVO getArct() {
		return arct;
	}

	public void setArct(ArtcVO arct) {
		this.arct = arct;
	}

	@Override
	public String toString() {
		return "TstVO(tstId: " + tstId + ", tstCtt: " + tstCtt + ", tstExamDt: " + tstExamDt + ", tstRgstDt: "
				+ tstRgstDt + ", tstUpdtDt: " + tstUpdtDt + ", tstDelDt: " + tstDelDt + ", tstDelYn: " + tstDelYn
				+ ", tstRspnsPth: " + tstRspnsPth + ", tstEdtPth: " + tstEdtPth + ", usrId: " + usrId + ", crsInfId: "
				+ crsInfId + ", artcId: " + artcId + ", tstStat: " + tstStat + ", sbjId: " + sbjId + ", )";
	}
}