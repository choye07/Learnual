...
public abstract class Readable<T> {
	...
	protected boolean isPresentFieldAnnotation(String fieldName) {
		...
		return isAnnotationPresent(field, com.learn.io.github.seccoding.excel.annotations.Field.class);
	}
	 ...
	 */
	protected com.learn.io.github.seccoding.excel.annotations.Field getFieldAnnotation(Field field) {
		if (isAnnotationPresent(field, com.learn.io.github.seccoding.excel.annotations.Field.class)) {
			return field.getDeclaredAnnotation(com.learn.io.github.seccoding.excel.annotations.Field.class);
		}
		return null;
	}
