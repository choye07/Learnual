      ...
      <div class="regist-section2">
        <form id="regist-agreement-form" action="/regist">
            ...
            <div class="regist-terms">
              ...
              <div class="textbox">
                <p>
                  ...
                  이 약관은 주식회사 러뉴얼(이하 "회사")가 제공하는 웹사이트(이하 "사이트")를
                  ...
                  ② 회사는 본 약관의 내용과 회사의 상호, 소재지, 대표자의 성명, 사업자등록번호, 연락처(전화, 팩스, e-mail주소 등) 등을 이용자가 알 수 있도록 사이트의 초기 서비스화면에
                  게시합니다.
                  ③ 회사는 약관의규제에관한법률, 전자거래기본법, 전자서명법, 정보통신망이용촉진및정보보호등에관한법률, 전자상거래등에서의소비자보호에관한법률, 방문판매등에관한법률, 소비자보호법,
                  개인정보보호법
                  등
                  관련법을 위배하지 않는 범위에서 본 약관을 변경할 수 있습니다.
                  ④ 회사는 필요하다고 인정되는 경우 본 약관을 변경할 수 있으며, 약관이 변경되는 경우에는 변경된 약관의 적용일자 및 사유를 명시한 변경된 약관과 현행 약관을 함께 지체없이 제8조에서
                  정한
                  방법으로 회원에게 공시합니다. 약관 변경 이전의 기존 회원이 제4항의 공시 기간 동안 변경된 약관에 동의하는 경우 변경약관의 조항이 적용됩니다.
                  ⑤ 회원이 변경된 약관에 동의하지 않으면 사이트를 탈퇴하여 서비스의 이용 계약을 해지할 수 있습니다. 단, 이의가 있음에도 제4항에 정한 바에 따른 회사의 고지가 있은 후 30일
                  이내에
                  이용
                  계약을 해지하지 않은 회원은 변경된 약관에 동의한 것으로 간주합니다.
                  ...
                  ② 서비스 이용신청자는 회사가 정한 양식에 따라 회원정보를 기입한 후 본 약관에 동의한다는 의사표시를 함으로써 회원가입 신청을 할 수 있습니다. 단, 서비스 이용신청자는 반드시
                  실명으로
                  ...
                  ② 회원 ID와 Password의 관리 소홀, 부정 사용에 의하여 발생하는 모든 결과에 대한 책임은 회원 본인에게 있으며, 회사의 시스템 고장 등 회사의 책임있는 사유로 발생하는
                  문제에
                  대한
                  책임은 회사에 있습니다.
                  ...
                  만일 회원이 타인의 저작권, 프로그램저작권 등을 침해하였음을 이유로 회사가 타인으로부터 손해배상청구 등 이의 제기를 받은 경우 회원은 회사의 면책을 위하여 노력하여야 하며, 회사가
                  면책되지
                  못한
                  경우 회원은 그로 인해 회사에 발생한 모든 손해를 부담하여야 한다.
                  ...
                  ② 회원은 본 약관에서 규정하는 사항과 기타 회사가 정한 제반 규정, 공지사항 등 회사가 공지하는 사항 및 관계 법령을 준수하여야 하며, 기타 회사의 업무에 방해가 되는 행위, 회사의
                  명예를
                  손상시키는 행위를 해서는 안됩니다.
                  ...
                  15. 컴퓨터 소프트웨어, 하드웨어, 전기통신 장비의 정상적인 가동을 방해, 파괴할 목적으로 고안된 소프트웨어 바이러스 기타 다른 컴퓨터 코드, 파일, 프로그램을 포함하고 있는 자료를
                  게시하거나
                  e-mail을 발송하는 행위
                  16. 기타 불법적이거나 부당한 행위
                  ...
                  ② 회사가 제3자에게 합병 또는 분할합병되거나 서비스를 제3자에게 양도함으로써 서비스의 제공 주체가 변경되는 경우, 사전에 제8조의 통지방법으로 회원에게 통지합니다. 이 경우 합병,
                  분할합병,
                  서비스 양도에 반대하는 회원은 회원탈퇴를 함으로써 서비스 이용계약을 해지할 수 있습니다.
                  ...
                  ④ 개인명의로 집합교육 서비스를 이용하고 개인이 수강료를 납부하는 경우 회원명은 반드시 회원 자신의 본명(실명)이어야 하며, 수강료 납부 책임자는 유료서비스 이용 회원 외에 타인으로
                  지정할
                  수
                  있습니다. 단, 유료서비스 이용자와 수강료 납부 책임자가 다른 경우 회사는 이를 확인할 수 있는 제증명을 요구할 수 있습니다.
                  ⑤ 개인명의로 집합교육 서비스를 이용하고 개인이 속한 법인 등 단체가 수강료를 납부하는 경우 회원명은 반드시 서비스를 이용하는 회원 자신의 본명(실명)이어야 하며, 수강료 납부는
                  서비스
                  이용
                  회원과 이용 회원이 속한 법인 등의 단체가 연대하여 책임을 집니다.
                  ...
                  ⑤ 제3항 또는 제4항에 의하여 수강신청의 승인을 유보하거나 승인하지 아니하는 경우, 회사는 이를 수강신청자에 알려야 합니다. 다만, 회사의 귀책사유 없이 수강신청자에게 통지할 수
                  없는
                  경우는
                  예외로 합니다.
                  ...
                  ① 회사는 회원이 사이트의 <수강취소>메뉴를 이용하여 집합교육 서비스의 수강취소를 요청하는 경우, 다음 각 호의 요건에 따라 환불이 가능합니다.
                    <1개월 이내 교육>
                      ...
                      <1개월 초과 교육>
                        - 교육 시작 후 환불사유가 발생한 그 달의 환불 대상 교육비(교육비 징수기간이 1개월 이내인 경우에 준하여 산출된 교육비를 말한다)와 나머지 달의 교육비 전액을 합산한
                        금액을
                        환불합니다.
                        ...
                        집합교육 서비스 수강자가 고용보험법상의 환급을 신청하는 경우에는 관계법 및 법령에서 요구하는 기준 및 요건에 부합되어야 하며, 이를 위해 수강자 소속의 고용보험 담당자를
                        통해
                        충분히
                        숙지하여야 합니다.
                        ...
                        ② 회원이 서비스를 이용함에 있어 행한 불법행위나 본 약관 위반행위로 인하여 회사가 당해 회원 이외의 제3자로부터 손해배상 청구 또는 소송을 비롯한 각정 이의제기를 받는
                        경우
                        당해
                        회원은 자신의 책임과 비용으로 회사를 면책시켜야 하며, 회사가 면책되지 못한 경우 당해 회원은 그로 인하여 회사에 발생한 모든 손해를 배상하여야 합니다.
              ...
              <div class="regist-terms-agree">
                <label>
                  <input type="radio" name="terms-agreement" value="agree" required>
                  동의함
                </label>
                <label>
                  <input type="radio" name="terms-agreement" value="disagree" required>
                  동의 안함
                </label>
              </div>
            </div>
            <div class="regist-private">
              ...
              <div class="textbox">
                <p>
                  ...
                  개인정보 수집 및 이용목적이 달성된 후에는 해당 정보를 지체없이 파기합니다. 참고로 kt ds는 '개인정보 유효기간제'에 따라 1년간 서비스를 이용하지 않은 회원의 개인정보를 별도로
                  분리 보관하여 관리하고 있습니다. 단, 다음의 정보에 대해서는 아래의 이유로 명시한 기간 동안 보관한 뒤 파기합니다
                  가. 교육서비스 이용
                  o 보존 항목 :
                  성명, 회원아이디, 비밀번호, 휴대폰번호, 이메일주소, 소속, 전화번호, 주소, 직급, 교육담당자, 담당자연락처, 담당자 이메일, 관심분야(경영/리더십), 관심분야(IT),
                  안내정보수신 이메일, 이메일 수신여부, 수강신청정보, 교육이력
                  o 보존이유 : 교육 이력 관리
                  o 보존기간 : 학습자 회원 탈퇴시까지
                  나. 관련 법령에 의한 정보보유 사유
                  관계법령의 규정에 의하여 보존할 필요가 있는 경우 회사는 관계법령에서 정한 일정한 기간 동안 회원정보를 보관합니다. 이 경우 회사는 보관하는 정보를 그 보관의 목적으로만 이용하며
                  보존기간은 아래와 같습니다
                  ...
                  다. 기타사유
                  o
                  보유기간을 이용자에게 미리 고지하고 그 보유기간이 경과하지 아니한 경우와 개별적으로 이용자께 사전에 동의를 받은 경우에는 약속한 보유기간 동안 보유
                  o 보존이유 : 교육 이력 관리
                  o 보존기간 : 학습자 회원 탈퇴시까지
                  ...
                  위 개인정보 중 필수적 정보의 수집·이용에 관한 동의는 대외교육 개인식별을 위하여 필수적이므로, 위 사항에 동의하셔야만 교육수강이 가능합니다. 위 개인정보 중 선택적 정보의
                  수집·이용에 관한 동의는 거부하실 수 있으며, 다만 동의하지 않으시는 경우 서비스 이용에 제한을 받으실 수 있습니다.

                </p>
              </div>
              <div class="regist-private-agree">
                <label>
                  <input type="radio" name="private-agreement" value="agree" required>
                  동의함
                </label>
                <label>
                  <input type="radio" name="private-agreement" value="disagree" required>
                  동의 안함
                </label>
              </div>
            </div>
          ...
          <div class="regist-option">
            ...
            <input type="checkbox" id="all-agreement" name="all-agree" />
            <label for="all-agreement">
              동의함
            </label>
          </div>
