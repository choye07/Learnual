...
<title>tst-board-view(회원)</title>
</head>

<body>
    <div class="tst-board board student view">
        ...
        <div class="board-wrapper">
          <form id="tst-form" action="#">
            ...
            <div class="tstTtl-area">
              <label>시험명</label>
              <input type="text" value="자바 기초 시험" />
            </div>
            <div class="tstExamDt-area">
              <label>정규 시험 날짜</label>
              <input type="text" value="2025-04-25 09:00:00" />
            </div>
            <!-- VO에 없음 주의 -->
            <div class="tutorNm-area">
              <label>강사명</label>
              <input type="text" value="박성연" />
            </div>
            <div class="tstRspnsPth-area">
              <label>응답 URL</label>
              <a href="#">https://google.com/forms/asdf</a>
            </div>
          </form>
        </div>
      </div>
