                ...
                <c:choose>
                  <c:when test="${not empty crntcList.ntcList}">
                    ...
                    <c:forEach items="${crntcList.ntcList}" var="crntc">
                      <c:if test="${crntc.crntcDelYn != 'Y' && crntc.crntcPinnedYn == 'Y'}">
                        <li class="pinned-notice-list"><a href="/crntc/view/${crntc.crntcId}">
                    ...
                    <!-- 상단 고정 체크되지 않은 게시글 -->
                    <c:forEach items="${crntcList.ntcList}" var="crntc">
                      <c:if test="${crntc.crntcDelYn != 'Y' && crntc.crntcPinnedYn == 'N'}">
