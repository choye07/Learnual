	...
	<div class="dashboard course student">
		...
		<div class="dashboard-main course student">
			<div class="main-wrapper cnsl">
				...
				<div class="cnsl-board board write">
					...
					<div class="board-body">
						<div class="board-wrapper">
							<form id="cnsl-request-form">
								<!-- form id, name, VO 확인하며 맞출 예정 -->
								<div class="1-area form-group">
									<label>제목</label> <input type="text" value="자격증 관련 상담요청입니다." />
								</div>
								<div class="instrNm-area form-group">
									<label>강사명</label> <input type="text" value="강좌 뷰에서 가져온 강사 이름" />
								</div>
								...
								<div class="btn-area">
									<button type="submit" class="btn-request">상담 요청</button>
