$(document).ready(function() {
    ...
    function getValidFileInputCount($form) {
        ...
        var realInputs = $form.find(".file-container input[type='file']").filter(function() {
            return this.files && this.files.length > 0;
        }).length;

        // 2. 기존 파일 항목: input 없이 a 태그만 있는 .file-item
        var existFiles = $form.find(".file-container .file-item").filter(function() {
    ...
    $("form.flarch-write-form, form.flarch-modify-form")
        ...
        .on("change", "input[type='file']", function() {
            ...
            var hasEmptyInput = $form.find(".file-container input[type='file']").filter(function() {
                return !this.files || this.files.length === 0;
            }).length > 0;
    ...
    $("form.flarch-modify-form")
        ...
        .on("click", function() {
            ...
            var flArchId = $("form.flarch-modify-form").find("input[name='flArchId']").val();
    ...
    */
    ...
    $(".course-manage").find(".btn-shutdown").on("click", function() {
        const crsInfId = $(this).data("id");
    ...
    /* 강좌 폐강 이벤트 start */
        ...
        /* coursemanage에서의 폐강 */
        $(".course-manage").find(".btn-abandon").on("click", function() {
            const crsInfId = $(this).data("id");
        ...
        /* courseconfirm에서의 폐강 */
        $(".course-confirm").find(".btn-abandon").on("click", function() {
            const crsInfId = $(this).data("id");
        ...
        $(".course-confirm").find('#btn-real-confirm').click(function () {
            const crsInfId = $(this).data('id');
