...
public class InstrVO {
	 ...
	 */
	private String instrLgnFailDt;

	/**
	 * @ColumnType NUMBER(1, 0)
	 * @ColumnComment 강사의 로그인에 실패한 횟수
	 */
	private int instrLgnFailCnt;

	/**
	 * @ColumnType CHAR(1)
	 * @ColumnComment 강사의 로그인 여부
	 */
	...
	public String getInstrLgnFailDt() {
		return instrLgnFailDt;
	}

	public void setInstrLgnFailDt(String instrLgnFailDt) {
		this.instrLgnFailDt = instrLgnFailDt;
	}
	
	public int getInstrLgnFailCnt() {
		return instrLgnFailCnt;
	}
	...
	public String toString() {
		return "InstrVO [instrId=" + instrId + ", instrLgnId=" + instrLgnId + ", instrLgnPw=" + instrLgnPw
				+ ", instrLgnSltPw=" + instrLgnSltPw + ", instrNm=" + instrNm + ", instrPn=" + instrPn + ", instrMl="
				+ instrMl + ", instrBrtDt=" + instrBrtDt + ", instrAdrs=" + instrAdrs + ", instrRgstDt=" + instrRgstDt
				+ ", instrUpdtDt=" + instrUpdtDt + ", instrDelDt=" + instrDelDt + ", instrDelYn=" + instrDelYn
				+ ", insttnId=" + insttnId + ", cmcdId=" + cmcdId + ", instrLgnIp=" + instrLgnIp + ", instrLstPwMdfyDt="
				+ instrLstPwMdfyDt + ", instrLstLgnDt=" + instrLstLgnDt + ", instrLgnFailDt=" + instrLgnFailDt
				+ ", instrLgnFailCnt=" + instrLgnFailCnt + ", instrLgnYn=" + instrLgnYn + ", instrBlkYn=" + instrBlkYn
				+ "]";
	}
