		...
		<div class="dashboard-main insttn">
			<div class="main-wrapper">
				...
				<div class="contents">
					...
					<div class="notice insttn-notice board write">
						<div class="board-header">
							<h1>학원 공지사항 작성</h1>
						</div>

						<form:form modelAttribute="insttnNtcWriteRequestVO"
