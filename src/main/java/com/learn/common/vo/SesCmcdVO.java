...
/**
 * @author 최예진 사용자들 등록 시 필요한 권한 select를 위한 CM_CODE 테이블의 VO
 */
public class SesCmcdVO {
	/**
	 * @ColumnName CMCD_ID
	...
	public String toString() {
		return "CmCodeVO(cmcdId: " + cmcdId + ", hghRnkCmcdId: " + hghRnkCmcdId + ", cmcdNm: " + cmcdNm
				+ ", cmcdRgstDt: " + cmcdRgstDt + ", cmcdUpdtDt: " + cmcdUpdtDt + ", cmcdDelDt: " + cmcdDelDt
				+ ", cmcdDelYn: " + cmcdDelYn + ", )";
	}
}
