				...
				<div class="assignment-board board write">
					...
					<div class="board-body">
						<div class="board-wrapper">
							<form id="assignment-view-form">
								<!-- form id, name, VO 확인하며 맞출 예정 -->
								<div class="nameA-area">
									<label>강좌명</label> <input type="text" value="현재 강의명이 들어옴" />
								</div>
								<div class="nameB-area">
									<label>과제 제출 시간</label> <input type="text" value="2025-04-29 오후 21:49" />
								</div>
								<div class="nameC-area">
									<label>제출 마감 시간</label> <input type="text" value="2025-04-30 오후 24:00" />
								</div>
								<div class="nameD-area">
									<label>과제 내용</label>
									<textarea name="" id="">과제에 대한 설명</textarea>
								</div>
								<div class="nameE-area">
									<label>제출 파일</label> <input type="file" />
								</div>
							</form>
						</div>
					</div>
