...
<body>
	<div class="wrapper">
		<jsp:include page="/WEB-INF/views/common/component/learnualheader.jsp" />
		    ...
		    <div class="manageEduad-main manage-board">
          ...
          <ul class="list-wrapper">
            <li>
              <a href="#">
                ...
                <div class="item-data3">김민철 강사</div>
                <div class="item-data4">Java1~4 강사</div>
              </a>
            </li>
            <li>
              <a href="#">
                ...
                <div class="item-data2">********</div>
                <div class="item-data3">송가연 강사</div>
                <div class="item-data4">UI/UX 강사</div>
              </a>
            </li>
          </ul>
          <!-- 페이지네이션 -->
