...
public class PrattVO {
    ...
    public String toString() {
        return "PrattVO(prattId: " + prattId + ", prattRgstDt: " + prattRgstDt + ", prattUpdtDt: " + prattUpdtDt + ", prattDelDt: " + prattDelDt + ", prattDelYn: " + prattDelYn + ", insttnId: " + insttnId + ", instrId: " + instrId + ", crsInfId: " + crsInfId + ", sbjId2: " + sbjId2 + ", )";
    }
}